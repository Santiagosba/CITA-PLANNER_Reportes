    ...
    extend: {
      ...
      keyframes: {
        ...
        'notice-glow': {
          ...
          '50%': { opacity: '0.62', transform: 'scale(1.22)' },
        },
        'notice-bell': {
      ...
      animation: {
        ...
        'notice-pop': 'notice-pop 420ms cubic-bezier(0.22, 1, 0.36, 1)',
        'notice-ring': 'notice-ring 900ms cubic-bezier(0.22, 1, 0.36, 1)',
        'notice-glow': 'notice-glow 1.6s ease-in-out infinite',
        'notice-bell': 'notice-bell 700ms cubic-bezier(0.22, 1, 0.36, 1)',
      },
    },
  },
  plugins: [],
